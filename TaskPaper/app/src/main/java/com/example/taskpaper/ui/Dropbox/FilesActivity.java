    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFilesAdapter = new FilesAdapter(PicassoClient.getPicasso(), new FilesAdapter.Callback() {
            ...
            public void onFileClicked(final FileMetadata file) {
                ...
                Log.d("Something", file.getPathLower());

//                DbxClientV2 client = DropboxClientFactory.getClient();
//                String delPath = file.getPathLower();
//                client.files().deleteV2(delPath);
//                mSelectedFile = file;
//                performWithPermissions(FileAction.DOWNLOAD);
    ...
    private void createDialog(FileMetadata file) {
        AlertDialog.Builder alertDlg = new AlertDialog.Builder(this);
        alertDlg.setMessage("Do you want to edit a file?");
